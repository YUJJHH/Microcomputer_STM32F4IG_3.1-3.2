...
// PD12을 출력설정하고 Alternate function(TIM4_CH1)으로 사용 선언
	GPIOD->MODER 	|= (<<24);	// GPIOD PIN12 Output Alternate function mode 					
	GPIOD->OSPEEDR 	|= (<<24);	// GPIOD PIN12 Output speed (50MHz High speed)
	GPIOD->PUPDR	&= ~(3<<24); 	// GPIOD PIN12 NO Pull-up
  					// PD12 ==> TIM4_CH1
	GPIOD->AFR[1]	|= (1<<17);	// Connect TIM4 pins(PD12) to AF2(TIM3..5)
 
// PD13: TIM4_CH2
// PD13을 출력설정하고 Alternate function(TIM4_CH2)으로 사용 선언
	GPIOD->MODER 	|= (2<<26);	// GPIOD PIN13 Output Alternate function mode 					
	GPIOD->OSPEEDR 	|= (<<26);	// GPIOD PIN13 Output speed (50MHz High speed)
...
// Timerbase Mode
	...
	TIM4->ARR = 10001-1;	// Auto reload  :  엔코더 count값 범위: 0~10000
...
// Output Compare Mode
	...
	// : TI2FP1 NonInverting / Rising Edge  
