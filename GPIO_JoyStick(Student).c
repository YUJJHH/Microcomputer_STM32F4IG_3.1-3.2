...
void DisplayInitScreen(void)
{
	...
	LCD_DisplayText(2,0,"1.LED1 Off");
        ...
        LCD_SetBackColor(RGB_WHITE);  //글자배경 흰색 ,글자색은 블랙임
        LCD_DisplayText(4,5,"U");
