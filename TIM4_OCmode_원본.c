...
// Time base 설정
	...
	TIM4->CR1 |= (1<<5); 	// CMS(Center-aligned mode Sel)=00 : Edge-aligned mode(reset state)

	// Setting the Period
	TIM4->PSC = 8400-1;	// Prescaler=84, 84MHz/84 = 1MHz (1us)
...
// Output Compare 설정
	...
	TIM4->CCMR1 |= (6<<4);	// OC1M=0b011 (Output Compare 1 Mode : toggle)
